    ...
    display: function(params) {
        ...
        var default_options = {
            ...
            header: {
                ...
                center: 'title',
                right:  'dayGridMonth, timeGridWeek, timeGridDay, listFull, resourceWeek, resourceTimeGridDay' // INFOTEL add resourceTimeGridDay
            },
        };
        ...
        this.calendar = new FullCalendar.Calendar(document.getElementById(GLPIPlanning.dom_id), {
            ...
            views: {
                ...
                resourceTimeGridDay: {
                    ...
                    duration: {weeks: CFG_GLPI.planning_weeks},
                    slotDuration: {days: 1},
                    hiddenDays: hidden_days,
                    groupByDateAndResource: true,
                },
            ...
            eventRender: function(info) {
                ...
                if (view.type == 'resourceTimeGridDay') {
                    eventtype_marker = '<span class="event_type"></span>';
                }
                // INFOTEL
                ...
                if (view.type !== 'dayGridMonth'
                    && view.type !== 'resourceTimeGridDay' // INFOTEL
