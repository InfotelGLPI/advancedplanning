...
abstract class CommonITILTask extends CommonDBTM implements CalDAVCompatibleItemInterface
{
   ...
   // SPECIFIC FUNCTIONS
     ...
     * @param array $options // INFOTEL
     * @return string Output
     **/
    public static function genericDisplayPlanningItem($itemtype, array $val, $who, $type = "", $complete = 0, $options = [])
    {
        /** @var array $CFG_GLPI */
        global $CFG_GLPI;
        ...
        switch ($options['view_name']) {
            case 'resourceTimeGridDay':
                if ($complete) {
                    ...
                    $html .= "<span>" . __('Description') . "</span>" . ": " . RichText::getEnhancedHtml($val["content"]) . $recall . "<br>";
                    $html .= $recall;
                    $html .= "</div>";
                } else {
                    $html .= "<div>";
